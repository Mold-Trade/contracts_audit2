...
interface IVaultUtils {
    ...
    function getBuyMusdFeeBasisPoints(
        address _token, uint256 _musdAmount) external view returns (uint256);
    function getSellMusdFeeBasisPoints(
        address _token, uint256 _musdAmount) external view returns (uint256);
    function getSwapFeeBasisPoints(
        address _tokenIn, address _tokenOut, uint256 _musdAmount) external view returns (uint256);
    function getFeeBasisPoints(
        address _token, uint256 _musdDelta,
