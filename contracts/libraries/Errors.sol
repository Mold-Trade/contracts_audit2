...
library Errors {
    ...
    string public constant TIMELOCK_INVALID_BUFFER = "Timelock: invalid _buffer";
    /* MUSD.sol*/
    string public constant MUSD_FORBIDDEN = "MUSD: forbidden";
    ...
    string public constant MLPMANAGER_INSUFFICIENT_MUSD_OUTPUT                  = "MlpManager: insufficient MUSD output";
    ...
    string internal constant REWARDROUTER_INVALID_MUSDAMOUNT                   = "RewardRouter: invalid _musdAmount";
